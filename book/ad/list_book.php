...
<?php
	...
	$rs=mysql_query($sql);
?>
<table class="hovertable" width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="table" >
      <tr>
...
?>
	    <tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
      <th height="25" colspan="10" align="center" >
    <?php
	if($pageno==1)
	{
	?>
